...
class TestPagerduty(asynctest.TestCase):
    ...
    def setUp(self):
        patcher1 = patch('charlesbot_pagerduty.pagerduty.get_pagerduty_schedules')  # NOQA
        self.addCleanup(patcher1.stop)
        self.mock_get_pagerduty_schedules = patcher1.start()

        patcher2 = patch('charlesbot_pagerduty.pagerduty.get_oncall_users')  # NOQA
        self.addCleanup(patcher2.stop)
        self.mock_get_oncall_users = patcher2.start()

        patcher3 = patch('charlesbot_pagerduty.pagerduty.send_oncall_response')  # NOQA
        self.addCleanup(patcher3.stop)
        self.mock_send_oncall_response = patcher3.start()

        patcher4 = patch('charlesbot_pagerduty.pagerduty.Pagerduty.load_config')  # NOQA
