...
class TestGetPagerdutySchedules(asynctest.TestCase):
    ...
    def setUp(self):
        patcher = patch('charlesbot_pagerduty.pagerduty_helpers.http_get_auth_request')  # NOQA
        self.addCleanup(patcher.stop)
        self.mock_http = patcher.start()
        self.mock_http.side_effect = {}
        from charlesbot_pagerduty.pagerduty_helpers import get_pagerduty_schedules  # NOQA
